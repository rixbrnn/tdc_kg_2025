...
--
-- Purpose: KILLER example showing SQL's complexity with hierarchies
-- Complexity: ⭐⭐⭐⭐⭐ (5/5) - Recursive CTE required
-- Expected Result: Manager names with team revenue (including all subordinates)
--
-- Demonstrates: When SQL starts to hurt
-- Pain Points: 30+ lines, complex recursive logic, hard to maintain
--
-- Employee.ReportsTo defines a hierarchy.
-- Customers are linked to their support rep (Employee).
-- We want each manager's revenue over ALL employees in their subtree.
...
-- ✗ Recursive CTE - requires understanding of advanced SQL
-- ✗ Three separate CTEs to manage hierarchy
-- ✗ Error-prone: Easy to make mistakes
-- 
-- → Compare with SPARQL: ONE LINE with property paths
